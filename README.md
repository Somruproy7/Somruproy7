...
<div align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=22&duration=3000&pause=1000&color=00C2FF&center=true&vCenter=true&width=600&height=80&lines=Full+Stack+Python+Developer+%F0%9F%90%8D;Django+%7C+Flask+%7C+REST+APIs+%7C+AWS;Building+scalable+production+systems+%F0%9F%9A%80" alt="Typing SVG" />
</div>
...
**Full Stack Python Developer** with 2+ years of experience building scalable web applications using **Django**, **Flask**, and **REST APIs**. Worked on real-world production systems including government financial platforms. Deployed on **AWS** with **CI/CD pipelines**.

- 🏆 Top 3 on HackerRank | JIS SAMMAN Award Recipient
- 📝 Published researcher — 3 papers in IOP Science, ISJEM & IJMR
- 📫 [somrupr15@gmail.com](mailto:somrupr15@gmail.com)

---

## 🚀 Projects

### 🛒 ShopHub — Full Stack E-Commerce Platform *(Oct 2025)*
Django + MongoDB e-commerce platform with REST APIs, secure auth, payment integration, and AWS deployment with CI/CD.

### 🎭 Face Recognition Attendance System *(Mar 2023)*
Real-time face recognition using Python, OpenCV, and MySQL for automated attendance tracking.
